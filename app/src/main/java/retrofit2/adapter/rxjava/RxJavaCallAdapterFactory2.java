...
public final class RxJavaCallAdapterFactory2 extends CallAdapter.Factory {
    ...
    public static RxJavaCallAdapterFactory2 createWithScheduler(Scheduler schedulerSubscribeOn, Scheduler schedulerObserveOn) {
    ...
    private RxJavaCallAdapterFactory2(@Nullable Scheduler schedulerSubscribeOn, Scheduler schedulerObserveOn, boolean isAsync) {
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        if (isCompletable) {
            return new RxJavaCallAdapter2(Void.class, schedulerSubscribeOn, schedulerObserveOn,isAsync, false, true, false, true,false);
        }
        ...
        if (rawObservableType == Response.class) {
            ...
            if (!(observableType instanceof ParameterizedType)) {
                throw new IllegalStateException("Result must be parameterized"
                        + " as GitHubPaging<Foo> or Result<? extends Foo>");
            }

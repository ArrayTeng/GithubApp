...
public class DrawableTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public DrawableTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            try {
                drawableLeft = a.getResourceId(R.styleable.drawableText_drawableText_leftDrawable, 0);
                drawableRight = a.getResourceId(R.styleable.drawableText_drawableText_rightDrawable, 0);
                drawableTop = a.getResourceId(R.styleable.drawableText_drawableText_topDrawable, 0);
                drawableBottom = a.getResourceId(R.styleable.drawableText_drawableText_bottomDrawable, 0);

                drawableWidth = a.getDimensionPixelSize(R.styleable.drawableText_drawableText_drawableWidth, 30);
                drawableHeight = a.getDimensionPixelSize(R.styleable.drawableText_drawableText_drawableHeight, 30);

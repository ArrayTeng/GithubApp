package com.example.todo.widget.bottom;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, UIUtilsKt.sp2px(context, titleTextSize));

        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, UIUtilsKt.getColor(context, R.color.color01));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, UIUtilsKt.getColor(context, R.color.color02));

        marginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, UIUtilsKt.dip2px(context, marginTop));
        ...
        unreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, UIUtilsKt.sp2px(context, unreadTextSize));
        unreadTextColor = ta.getColor(R.styleable.BottomBarItem_unreadTextColor, UIUtilsKt.getColor(context, R.color.color04));
        unreadTextBg = ta.getDrawable(R.styleable.BottomBarItem_unreadTextBg);

        msgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, UIUtilsKt.sp2px(context, msgTextSize));
        msgTextColor = ta.getColor(R.styleable.BottomBarItem_msgTextColor, UIUtilsKt.getColor(context, R.color.color04));
    ...
    public void setNormalIcon(int resId) {
        setNormalIcon(UIUtilsKt.getDrawable(context, resId));
    }
    ...
    public void setSelectedIcon(int resId) {
        setSelectedIcon(UIUtilsKt.getDrawable(context, resId));
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            this.context = context;
            titleTextSize = UIUtilsKt.sp2px(context, 12);
            titleNormalColor = getColor(R.color.color01);
            titleSelectedColor = getColor(R.color.color02);
            unreadTextSize = UIUtilsKt.sp2px(context, 10);
            msgTextSize = UIUtilsKt.sp2px(context, 6);
            unreadTextColor = getColor(R.color.color04);
            unreadNumThreshold = 99;
            msgTextColor = getColor(R.color.color04);
        }
        ...
        public Builder titleTextSize(int titleTextSize) {
            this.titleTextSize = UIUtilsKt.sp2px(context, titleTextSize);
            return this;
        }
        ...
        public Builder unreadTextSize(int unreadTextSize) {
            this.unreadTextSize = UIUtilsKt.sp2px(context, unreadTextSize);
            return this;
        }
        ...
        public Builder msgTextSize(int msgTextSize) {
            this.msgTextSize = UIUtilsKt.sp2px(context, msgTextSize);
            return this;
        }
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(UIUtilsKt.getDrawable(context, normalIconId), UIUtilsKt.getDrawable(context, selectedIconId), text);
        }

package com.example.todo.widget.titlebar;
...
import com.example.todo.base.R;
import com.example.todo.utils.StatusBarUtil;
import com.example.todo.utils.UIUtilsKt;
...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_5 = UIUtilsKt.dp2PxInt(context, 5);
        PADDING_12 = UIUtilsKt.dp2PxInt(context, 12);
        ...
        titleBarHeight = (int) array.getDimension(R.styleable.CommonTitleBar_titleBarHeight, UIUtilsKt.dp2PxInt(context, 44));
        ...
        bottomShadowHeight = array.getDimension(R.styleable.CommonTitleBar_bottomShadowHeight, UIUtilsKt.dp2PxInt(context, 0));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, UIUtilsKt.dp2PxInt(context, 16));
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextSize = array.getDimension(R.styleable.CommonTitleBar_rightTextSize, UIUtilsKt.dp2PxInt(context, 16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.CommonTitleBar_centerTextSize, UIUtilsKt.dp2PxInt(context, 18));
            ...
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize, UIUtilsKt.dp2PxInt(context, 11));
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, UIUtilsKt.dp2PxInt(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, UIUtilsKt.dp2PxInt(context, 0.4f)));
            ...
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT, UIUtilsKt.dp2PxInt(context, bottomShadowHeight));
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            btnLeft.setId(StatusBarUtil.generateViewId());
            ...
            if (viewCustomLeft.getId() == View.NO_ID) {
                viewCustomLeft.setId(StatusBarUtil.generateViewId());
            }
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            btnRight.setId(StatusBarUtil.generateViewId());
            ...
            if (viewCustomRight.getId() == View.NO_ID) {
                viewCustomRight.setId(StatusBarUtil.generateViewId());
            }
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            // 设置跑马灯效果
            tvCenter.setMaxWidth((int) (UIUtilsKt.getScreenPixelSize(context)[0] * 3 / 5.0));
            ...
            int progressWidth = UIUtilsKt.dp2PxInt(context, 18);
            ...
            // 设置边距
            centerParams.topMargin = UIUtilsKt.dp2PxInt(context, 7);
            centerParams.bottomMargin = UIUtilsKt.dp2PxInt(context, 7);
            ...
            ivSearch.setId(StatusBarUtil.generateViewId());
            ivSearch.setOnClickListener(this);
            int searchIconWidth = UIUtilsKt.dp2PxInt(context, 15);
            ...
            ivVoice.setId(StatusBarUtil.generateViewId());
            ...
            etSearchHint.setTextSize(TypedValue.COMPLEX_UNIT_PX, UIUtilsKt.dp2PxInt(context, 14));
            ...
            if (centerCustomView.getId() == View.NO_ID) {
                centerCustomView.setId(StatusBarUtil.generateViewId());
            }
    ...
    public void showSoftInputKeyboard(boolean show) {
        if (centerSearchEditable && show) {
            ...
            UIUtilsKt.showSoftInputKeyBoard(getContext(), etSearchHint);
        } else {
            UIUtilsKt.hideSoftInputKeyBoard(getContext(), etSearchHint);
        }
    }
